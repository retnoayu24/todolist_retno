...
export const getTodoById = async (
    ...
    try {
        ...
        // Jika undefined, berarti todo tidak ditemukan
        // atau bukan milik user ini
        if (!todo) {
            res.status(404).json({
                success: false,
...
export const updateTodo = async (
    ...
    try {
        ...
        // Jika affectedRows = 0, berarti todo tidak
        // ditemukan atau bukan milik user ini
        if (affectedRows === 0) {
            res.status(404).json({
                success: false,
                message: 'Tugas tidak ditemukan!'
